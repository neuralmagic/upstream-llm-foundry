...
export RUN_NAME=oneshot_wEOS_sp${SPARSITY}_${PRECISION}_maxseq${MAX_SEQ_LEN}_${MAX_DURATION}_cosineLR${LR}_warmup${WARMUP}_noGradClip_globalBS${GLOBAL_BS}_evalInterval${EVAL_INTERVAL}_wEOS_noWrap

composer train_sparse.py \
    yamls/pretrain/llama3_8b_cosmopedia_alldownstream.yaml \
