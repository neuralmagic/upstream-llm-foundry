...
export RUN_NAME=wPositionIDS_DownFixedShubhraDedup_SYN8BwdiffsOpenLLM4x_SYN8Bopenmath1x_FineWebEdu10BT_oneshot_wEOS_sp${SPARSITY}_${PRECISION}_maxseq${MAX_SEQ_LEN}_${MAX_DURATION}_cosineLR${LR}_warmup${WARMUP}_GradClip2_globalBS${GLOBAL_BS}_evalInterval${EVAL_INTERVAL}_wEOS_noWrap
