...
export DATA_LOCAL=/network/eldar/datasets/llama2_7b_SlimPajama_seq4k_tokenized

export WANDB_ENTITY=eldarkurtic
export WANDB_DISABLED=False
export WANDB_PROJECT=llama2_7b_SlimPajama
...
export MAX_DURATION=50000ba #1ep
...
composer train_sparse.py \
    yamls/pretrain/llama2_7b_slimpajama.yaml \
