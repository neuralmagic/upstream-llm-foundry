...
python3 convert_custom_dataset.py \
    --dataset cais/mmlu --splits train --data_subset auxiliary_train \
    --out_root /nm/drive0/eldar/datasets/llama3_8b/seqlen8k_tokenized_wEOS_yesWrap/mmlu_auxiliary_train \
