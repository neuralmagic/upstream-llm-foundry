...
python3 convert_custom_dataset.py \
    --dataset cognitivecomputations/dolphin --splits train --data_subset flan5m-alpaca-uncensored \
    --out_root /nm/drive0/eldar/datasets/llama3_8b/seqlen8k_tokenized_wEOS_yesWrap/dolphin_flan5m \
