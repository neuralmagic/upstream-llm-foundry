...
export CKPT=DownFixedFull_SYN8BwdiffsOpenLLM4x_SYN8Bopenmath1x_FineWebEdu10BT_oneshot_wEOS_sp24_amp_bf16_maxseq8192_1ep_cosineLR1e-4_warmup600ba_GradClip2_globalBS128_evalInterval6000ba_wEOS_noWrap
echo $CKPT
